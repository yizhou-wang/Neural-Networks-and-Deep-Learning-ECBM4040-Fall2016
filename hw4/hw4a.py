...
from hw4_nn import RNNSLU, RNNSLU_norm
...
class RNNSLU2(object):
    ...
    def __init__(self, nh, nh2, nc, ne, de, cs, normal=True):
        ...
        self.wh = theano.shared(name='wh',
                                ...
                                (nh, nh))
                                .astype(theano.config.floatX))
        self.wh12 = theano.shared(name='wh12',
                                value=0.2 * numpy.random.uniform(-1.0, 1.0,
                                (nh, nh2))
                                .astype(theano.config.floatX))
        ...
        # bundle
        self.params = [self.emb, self.wx, self.wh, self.wh12, self.wh2, self.w, 
        ...
        def recurrence(x_t, h_tm1, h2_tm1):
            ...
            h2_t = T.nnet.sigmoid(T.dot(h_t, self.wh12) + T.dot(h2_tm1, self.wh2) + self.bh2)
